...
Current public GitHub count: **558 repos** (LegalTech 6-pack + EnergyTech 6-pack + DefenseTech 6-pack + RetailTech 6-pack + matter-decision-record-audit-stream-reference + Squad Phase 2 mass harden + Codex action wave + Sales Enablement Stack + Executive Intelligence Stack). Operator-surface hardening backlog (squad doctrine v1.1): **50 .kineticgain.com subdomains** now at `v1.0-prod` (was 49 — added scopes.kineticgain.com on 2026-06-02), every Codex-shipped v0.1 caught up — zero gaps remaining at the cutoff. The full grouped index is at [kineticgain.com/constellation](https://kineticgain.com/constellation/). Constellation security posture: **30 / 30 buyer-facing surfaces at A/90** on the kg-header-audit rubric — HSTS preload-ready, CSP locked, fonts self-hosted, COEP `require-corp` enabled.
